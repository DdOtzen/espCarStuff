"""
Module: 'usys' on micropython-v1.20.0-537-esp32-Generic_ESP32_module_with_ESP32
"""
...
path = [] # type: list
version = '3.4.0; MicroPython v1.20.0-537-g6f4daccaf-dirty on 2023-10-02' # type: str
ps1 = '>>> ' # type: str
ps2 = '... ' # type: str
